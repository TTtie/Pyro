...
param.message.member.getVoiceChannel().join(false,false).then(voice =>{
    var encoder = voice.voiceConnection.createExternalEncoder({type: "ffmpeg", source: "Pyro_laughlong01.wav"});
    encoder.once("end", () => {console.log("Sucessfully played Pyro_laugh_long01.wav");
